...
class SEOConfig:
    ...
    DEFAULT_TWITTER_SITE = "@dhifff__"
    
    # Site information
    SITE_NAME = "mnkdigital.tech"
    AUTHOR = "Muhammad Nadhif Karim"
    SITE_URL = getattr(settings, 'SITE_URL', 'https://mnkdigital.tech')
    ...
    COMMON_KEYWORDS = {
        'personal': [
            'dhiff', 'Mnk', 'Karim', 'mnkdigital.tech',
            'blog mnkdigital', 'mnk portfolio',
