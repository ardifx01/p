...
class SkillsData:
    ...
    tech_stack = {
        ...
        "ckeditor": {
           "name": "CKEditor",
           "description": "Rich text editor for modern web applications",
           "icon_svg": f"{settings.BASE_URL}/static/svg/icon/skills-icons/icons/ckeditor.svg"
        },
        "redux": {
           "name": "Redux",
           "description": "State management library for React applications",
           "icon_svg": f"{settings.BASE_URL}/static/svg/icon/skills-icons/icons/redux-original.svg"
        },
       "reactnative": {
           "name": "React Native",
