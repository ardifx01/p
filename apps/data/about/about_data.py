...
class AboutData:
    ...
    def get_about_data(cls):
        return {
            "name": "Muhammad Nadhif Karim",
            "first_name": "Muhammad Nadhif",
            "last_name": "Karim",
            "username": "dhiff", # GitHub username
            "aka": "mnk",
            "image_url": f"{settings.BASE_URL}/static/img/dhiff.webp",
            ...
            "stories": [
                ...
                "My elementary school education was at Darul Ulum Elementary School, then junior high school at SMP N 1 Batang, and finally vocational school at SMK N 1 Batang, I learned coding autodidactically from junior high school until now.",
