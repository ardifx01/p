...
# penting kalau behind reverse proxy (nginx/cf)
...
STATIC_URL = "/static/"
STATIC_ROOT = BASE_DIR / "staticfiles"  # FIX: jangan pakai '/staticfiles' (absolute)
STATICFILES_STORAGE = "whitenoise.storage.CompressedManifestStaticFilesStorage"

# paksa cache 1 tahun untuk hashed assets
WHITENOISE_MAX_AGE = 31536000
# file hashed dari Manifest aman immutable
